...
dialog = [
    ...
    [
        (2, '莉子：\n工會發現哥布林王只是魔族派來的探子，\n現在魔族開始派出更強大的魔物了！'),
        (2, '莉子：\n從今天開始，我們要學習漢字（Kanji）！\n只要一個字就能蘊含強大的魔力，是更高階的魔法！'),
        (2, '莉子：\n我們先從「數字」開始，這能倍增你的魔法威力！\n一(いち)、二(に)、三(さん)、四(よん)、五(ご)...'),
        (2, '莉子：\n還有大數字：百(ひゃく)、千(せん)、万(まん)、\n億(おく)、兆(ちょう)！千萬別搞混了！'),
        (1, '赤真：\n數字也能當魔法？感覺我的攻擊力要翻倍了！\n等等，莉子，你臉色不太好，沒事吧？'),
        (2, '莉子：\n不知道為什麼，當我教你漢字時，腦海中開始出現\n精靈族言靈魔法的傳承記憶...\n (但我明明是人類啊...)'),
        (1, '赤真：\n精靈族？！看來這座森林藏著很多秘密... \n小心，魔物攻過來了！')
    ],
    #stage 10
    [
        (2, '莉子：\n嗚... 頭好痛！'),
        (1, '赤真：\n莉子！你怎麼了？！'),
        (2, '莉子：\n我體內的血脈好像發生了衝突，\n但現在不是休息的時候，這批魔物帶有自然元素的屬性！'),
        (2, '莉子：\n我必須教你元素相關的漢字！聽好，最基本的七曜：\n日(にち)、月(つき)、火(か)、水(みず)、木(き)、金(きん)、土(つち)！'),
        (2, '莉子：\n還有氣候與光影：光(ひかり)、闇(やみ)、風(かぜ)、\n雷(かみなり)、雪(ゆき)... 咳咳！(痛苦捂頭)'),
        (1, '赤真：\n莉子，你別勉強了！快停下來！\n接下來的元素漢字魔法全部交給我來施展！')
    ],
    #stage 11
    [
        (2, '莉子：\n謝謝你，赤真。抱歉拖累你了...\n我們繼續練習吧，這次是動物和日常用品的漢字。'),
        (1, '赤真：\n你確定不需要再休息一下嗎？'),
        (2, '莉子：\n沒關係！記住，動物類有猫(ねこ)、犬(いぬ)、\n鳥(とり)、魚(さかな)！'),
        (2, '莉子：\n物品類有本(ほん)、車(くるま)、鞄(かばん)、\n時計(とけい)、傘(かさ)、靴(くつ)！'),
        (2, '莉子：\n對了，這次的施法方式不同！你要把正確的選項\n「拖曳」到對應的空缺處，把詞彙拼湊完整才能發動言靈！'),
        (1, '赤真：\n拖曳式詠唱？我明白了！\n你好好休息，看我用新學的字把這些魔物全部清掉！')

    ],
    #stage 12
    [
        (1, '赤真：\n呼... 魔族的入侵越來越頻繁了，這樣下去不是辦法。'),
        (2, '莉子：\n嗯... 而且我的傳承記憶也越來越清晰... \n我隱約對自己的身分產生懷疑了。'),
        (1, '赤真：\n別想太多，等這波魔物清理完，我們去調查一下吧，\n或許能找到線索。'),
        (2, '莉子：\n好。前方地形很複雜，你要掌握自然景物的漢字：\n山(やま)、川(かわ)、空(そら)、海(うみ)、森(もり)！'),
        (2, '莉子：\n還有植物與大地的字：花(はな)、草(くさ)、葉(は)、\n石(いし)、泥(どろ)。把它們的讀音牢牢記住！'),
        (1, '赤真：\n沒問題！利用地形環境也是言靈魔法的基礎對吧？\n看我的表現吧！')
    ],
    #stage 13
    [
        (1, '赤真：\n漢字的數量真多，但我能感覺到法術的威力正在倍增。'),
        (2, '莉子：\n沒錯！接下來為了精準打擊敵人，你需要具備空間感，\n我們來學習「方位與位置」的漢字！'),
        (2, '莉子：\n記好基礎位置：上(うえ)、下(した)、左(ひだり)、右(みぎ)、\n前(まえ)、後(うしろ)、中(なか)、外(そと)！'),
        (2, '莉子：\n還有東(ひがし)南(みなみ)西(にし)北(きた)，\n以及遠(とお)く、近(ちか)く、隣(となり)！'),
        (2, '莉子：\n因為需要精準定位，這次你必須用「拖曳」的方式，\n把方向拖進對應的位置來發動言靈！'),
        (1, '赤真：\n原來如此！上下左右全部鎖定，\n一隻魔物都別想逃出我的施法範圍！')
    ],
    #stage 14
    [
        (1, '赤真：\n這附近的瘴氣越來越重了，感覺呼吸有點困難...'),
        (2, '莉子：\n大家都要小心，魔族的前鋒部隊隨時會出現。\n用漢字魔法來強化我們的身體素質吧！'),
        (2, '莉子：\n聽好身體部位的讀音：頭(あたま)、髪(かみ)、\n手(て)、足(あし)、指(ゆび)、首(くび)、肩(かた)！'),
        (2, '莉子：\n五官也很重要：目(め)、口(くち)、耳(みみ)、\n鼻(はな)、歯(は)！'),
        (2, '莉子：\n最後是人物的稱呼：人(ひと)、男(おとこ)、女(おんな)！\n用這些字來施展強化防禦吧！'),
        (1, '赤真：\n好！強化「目」來洞察瘴氣，強化「足」來閃避攻擊！\n我們一鼓作氣衝過去！')
     ],
    #stage 15
    [
        (1, '赤真：\n漢字魔法不僅能攻擊，還能用來防禦和干擾，\n真是博大精深。'),
        (2, '莉子：\n沒錯，所以你要完全掌握它們！\n接下來我們來學習操控「時間與時期」的漢字。'),
        (2, '莉子：\n掌握時間概念能讓你的魔法發動得更精準！\n先記住：今(いま)、時(じ)、分(ふん)、半(はん)。'),
        (2, '莉子：\n還有表示一天的時間段：朝(あさ)、昼(ひる)、\n夕方(ゆうがた)、夜(よる)。'),
        (2, '莉子：\n以及日期的概念：昨日(きのう)、今日(きょう)、\n明日(あした)、毎日(まいにち)、週(しゅう)、年(ねん)。'),
        (2, '莉子：\n這次一樣是用「拖曳」的方式施法，\n把正確的時間詞彙拖入法陣中，精準調整詠唱的時機！'),
        (1, '赤真：\n調整魔法的時機嗎？我懂了！\n就算是「昨日」受到的傷，我也要在「今日」全部討回來！')
    ],
    #stage 16
    [
        (1, '赤真：\n魔物的數量越來越多了，我們得加快清理速度！'),
        (2, '莉子：\n那我們來學習「形容詞」吧！只要加上形容詞，\n就能改變魔法的規模與屬性！'),
        (2, '莉子：\n記好大小高低：大きい(おおきい)、小さい(ちいさい)、\n高い(たかい)、低い(ひくい)。'),
        (2, '莉子：\n溫度的變化：暑い/熱い(あつい)、寒い(さむい)、冷たい(つめたい)。\n還有長(ながい)短(みじかい)、新(あたらしい)舊(ふるい)！'),
        (2, '莉子：\n最後是好(よい)壞(わるい)與多(おおい)少(すくない)！\n用形容詞來強化你的魔法吧！'),
        (1, '赤真：\n明白了！看我的「大きい」火球跟「冷たい」冰風暴！')
    ],
    #stage 17
    [
        (1, '赤真：\n呼... 終於清得差不多了。不過牠們的動作好靈活！'),
        (2, '莉子：\n這時候就需要「動詞」來預判並限制牠們的行動了！\n我們來學習基礎的「ます形」動作！'),
        (2, '莉子：\n移動類：行きます(去)、来ます(來)、帰ります(回)、\n走ります(跑)、出掛けます(出門)、泳ぎます(游泳)。'),
        (2, '莉子：\n日常動作：食べます(吃)、飲みます(喝)、起きます(起床)、\n寝ます(睡覺)、買います(買)！'),
        (2, '莉子：\n感官與學習：見ます(看)、聞きます(聽)、読みます(讀)、\n書きます(寫)！把它們的平假名讀音記熟！'),
        (1, '赤真：\n沒問題！我會「見ます」牠們的破綻，一擊打倒！'),
        (2, '莉子：\n(捂著胸口，低聲說)......奇怪，為什麼心跳得這麼快，\n好像有什麼可怕的東西要甦醒了...')
    ],
    #stage 18
     [
        (1, '赤真：\n莉子，小心！地面的震動越來越強，\n前面那個傢伙的氣息跟之前的魔物完全不同！'),
        (2, '莉子：\n(喘氣) 是中級Boss... 呃啊！我的頭...好痛！\n這股氣息在強行喚醒我的記憶...！'),
        (2, '莉子：\n赤真！趁Boss還沒完全現身，快學會「星期與時間」的漢字！\n這能發動時空鎖鏈牽制牠！'),
        (2, '莉子：\n記好一週的念法：\n星期一 月曜日(げつようび)、星期二 火曜日(かようび)、\n星期三 水曜日(すいようび)。'),
        (2, '莉子：\n星期四 木曜日(もくようび)、星期五 金曜日(きんようび)、\n星期六 土曜日(どようび)、星期日 日曜日(にちようび)！'),
        (2, '莉子：\n還有週末(しゅうまつ)、平日(へいじつ)！\n先週(せんしゅう)、今週(こんしゅう)、来週(らいしゅう)！'),
        (2, '莉子：\n加上去年(きょねん)與来年(らいねん)！\n這關一樣要用「拖曳」來施法！'),
        (1, '赤真：\n莉子，妳的臉色太蒼白了！快躲到我身後！'),
        (2, '莉子：\n不行...那股力量在呼喚我，如果我繼續留在這裡，\n我體內的詛咒會失控傷害到你的！'),
        (1, '赤真：\n什麼詛咒？！莉子，妳要去哪裡？！'),
        (2, '莉子：\n對不起，赤真... 你先獨自撐住，我必須離開去壓制這股力量！\n我們...一定會再見面的！(轉身跑進森林深處)'),
        (1, '赤真：\n莉子！等等！...可惡，魔物擋住路了，我得先解決這關！')
    ],
    #stage 19
    [
        (3, '【一週後...】'),
        (0, '系統：\n【警告】中級Boss『天魔』降臨！\n'),
        (1, '赤真：\n這一週來，我一直在尋找妳的下落... 莉子！\n可惡，這傢伙的防禦力太誇張了，一般的魔法根本打不穿！'),
        (2, '莉子：\n赤真！我回來了！退後，讓我來打破牠的絕對防禦！'),
        (1, '赤真：\n莉子！妳終於回來了！妳沒事了嗎？！'),
        (2, '莉子：\n嗯，離開的這段時間，我徹底覺醒並接納了傳承記憶。\n我終於知道我的真實身分了...我是天神遺落的精靈武器。'),
        (2, '莉子：\n啊啊啊啊——（詠唱最強咒文）『天神破甲之光』！'),
        (3, '高空出現一個巨大的魔法陣，強光瞬間粉碎了天魔的護盾！\n受創的天魔掉落了護甲『天神甲』與武器『天魔杖』。'),
        (2, '莉子：\n赤真... 我的血脈還能衍生出另一個作用。\n我可以化身為你最強的武器，但代價是...失去生命。'),
        (1, '赤真：\n開什麼玩笑！我等了妳整整一週，\n絕對不允許這種事發生！！'),
        (1, '赤真：\n既然天魔的防禦已經被妳打破了，接下來就交給我！\n我會用所有學過的漢字魔法，徹底擊潰牠！')
     ],
    #stage 20
    [
        (1, '赤真：\n（看著莉子，我必須變得更強...強到不需要任何人為我犧牲！）'),
        (2, '莉子：\n赤真... 前方的魔物開始懂得防禦單一的漢字魔法了。\n接下來我們要學習「句子結構（Sentence Structure）」！'),
        (2, '莉子：\n把散落的詞彙結合成完整的句子，能大幅提升言靈的穩定度。\n先從最基礎的「A是B」開始：AはBです。'),
        (2, '莉子：\n例如：わたし は あかまさ です。(我是赤真)\n或者：これ は りんご です。(這是蘋果)'),
        (2, '莉子：\n這次的詠唱方式是「句子重組」！\n你必須把單字依照正確的順序拖曳到橫線上，然後點擊詠唱！'),
        (1, '赤真：\n交給我吧，不管多複雜的文法我都能學會！\n看我把它們的護盾全部轟碎！')
    ],
    #stage 21
    [
        (2, '莉子：\n接下來，為了讓魔法精準命中目標，\n你要學會使用「助詞」來連接名詞與動作！'),
        (2, '莉子：\n「を(wo)」用來表示動作的對象。例如：\nりんご を たべます。(吃蘋果)'),
        (2, '莉子：\n「に(ni)」用來表示存在的地點或動作的目的地。\n例如：うち に かえります。(回家)'),
        (2, '莉子：\n「へ(e)」用來表示移動的方向。例如：\nびょういん へ いきます。(往醫院去)'),
        (1, '赤真：\n加上助詞後，詠唱就像鎖定目標一樣精準！\n我已經抓到訣竅了。')
    ],
    #stage 22
    [
        (2, '莉子：\n現在把主詞、助詞、受詞和動詞全部結合起來！\n這是日文句子的核心骨架：主詞＋は＋受詞＋を＋動詞。'),
        (2, '莉子：\n例如：わたし は にく を たべます。(我吃肉)\n或者：せんせい は ほん を よみます。(老師看書)'),
        (1, '赤真：\n主詞、受詞和動詞的順序跟中文完全不一樣...\n動詞居然要放在最後面！'),
        (2, '莉子：\n沒錯！這就是言靈的規則，直到最後一個字詠唱完畢，\n魔法的型態才會真正確定！'),
        (1, '赤真：\n有了完整的句子，言靈魔法的範圍和破壞力都提升了！\n這就是語言的力量，看我的！')
    ],
    #stage 23
    [
        (2, '莉子：\n赤真，這是最後一組句子重組訓練了！\n我們要加入「時間」與「地點」，讓魔法更加立體！'),
        (2, '莉子：\n表示動作發生的時間（如：きょう、あした、きのう）\n通常放在句子的最前面。'),
        (2, '莉子：\n而動作發生的場所，要加上助詞「で」。\n例如：がっこう で ほん を よみます。(在學校看書)'),
        (2, '莉子：\n如果是一起去：あした もり へ いきます。(明天去森林) \n或者：レストラン で にく を たべます。(在餐廳吃肉)'),
        (1, '赤真：\n時間、地點、受詞、動詞... 把這些完美組合起來吧！\n這些魔物根本撐不住我的一句完整詠唱！')
    ],
    #stage 24
    [
        (2, '莉子：\n句子結構掌握後，最核心的魔法型態轉換來了！\n也就是動詞變化（Verb form）！'),
        (2, '莉子：\n之前學的「ます形」是禮貌的魔法型態。\n現在你要學會還原動詞的本質：「辞書形（原形）」！'),
        (2, '莉子：\n日文動詞分為三類。第一類動詞的「ます」前面是い段音，\n變成原形時，要把い段音改成う段音。'),
        (2, '莉子：\n例如：行きます(いき・ます) 變成 行く(いく)。\n飲みます(のみ・ます) 變成 飲む(のむ)。'),
        (2, '莉子：\n第二類動詞的「ます」前面通常是え段音或單個い段音，\n只要去掉「ます」直接加上「る」。\n例如：食べます(たべ・ます) 變成 食べる(たべる)。'),
        (2, '莉子：\n第三類只有兩個不規則動詞：\n来ます(きます) 變成 来る(くる)，\nします(做) 變成 する。'),
        (2, '莉子：\n從這關開始，詠唱方式改變了！你必須在鍵盤上\n「輸入答案的羅馬拼音」，然後按Enter發動言靈！'),
        (1, '赤真：\n三類動詞的規則嗎？我記住了！\n看我用原形動詞給牠們迎頭痛擊！')
    ],
    #stage 25
     [
        (2, '莉子：\n很好！接下來是能讓魔法產生連續效果的「て形」！\n它可以用來連接動作或是表示輕微的命令。'),
        (2, '莉子：\nて形的變化規則比較複雜，同樣看動詞的分類！\n第二類跟第三類最簡單，把「る」去掉換成「て」。'),
        (2, '莉子：\n例如：食べる(たべる) 變成 食べて(たべて)。\n起きる(おきる) 變成 起きて(おきて)。'),
        (2, '莉子：\n但第一類動詞要看原形字尾！如果是「う、つ、る」，\n會發生促音便，變成「って」。\n例如：買う(かう) 變成 買って(かって)。'),
        (2, '莉子：\n字尾是「ぬ、ぶ、む」，會發生撥音便，變成「んで」。\n例如：飲む(のむ) 變成 飲んで(のんで)。'),
        (2, '莉子：\n字尾是「く、ぐ」，會發生い音便，變成「いて、いで」。\n例如：書く(かく) 變成 書いて(かいて)！\n唯一例外是「行く(いく)」，變成「行って(いって)」。'),
        (1, '赤真：\n促音便、撥音便、い音便... 變化規則好多啊！\n但我會在實戰中快速反應，輸入羅馬拼音的！看招！')
    ],
    #stage 26
    [
        (2, '莉子：\n赤真，幹得好！接下來我們要學習「ない形」！\n這是否定型態，能用來消除敵人的增益狀態或中斷牠們的詠唱！'),
        (2, '莉子：\n變化的規則一樣要看動詞的分類！\n第一類動詞，要把字尾的「う段音」改成「あ段音」，再加上「ない」。'),
        (2, '莉子：\n例如：書く(かく) 變成 書かない(かかない)。\n飲む(のむ) 變成 飲まない(のまない)。\n但要注意！字尾是「う」的，要變成「わ」！\n例如：買う(かう) 變成 買わない(かわない)。'),
        (2, '莉子：\n第二類動詞最簡單，直接把字尾的「る」去掉，加上「ない」。\n例如：食べる(たべる) 變成 食べない(たべない)。'),
        (2, '莉子：\n第三類不規則動詞：\n来る(くる) 變成 来ない(こない)。\nする 變成 しない。'),
        (1, '赤真：\n把「う段」變成「あ段」加上「ない」...我記住了！\n這招實用！看我把它們的護盾全部「しない」(消除)！')
    ],
    #stage 27
    [
        (2, '莉子：\n這附近的魔物越來越強了，我們必須掌握時間干涉的魔法！\n接下來是「た形」，用來表示過去發生的事或動作完了！'),
        (2, '莉子：\n好消息是，「た形」的變化規則跟上一關學的「て形」完全一樣！\n只要把「て」換成「た」，「で」換成「だ」就可以了！'),
        (2, '莉子：\n所以第一類動詞的音便規則也相同：\n促音便(うつる)：買う(かう) 變成 買った(かった)。\n撥音便(ぬぶむ)：飲む(のむ) 變成 飲んだ(のんだ)。'),
        (2, '莉子：\nい音便(くぐ)：書く(かく) 變成 書いた(かいた)。\n例外：行く(いく) 變成 行った(いった)！'),
        (2, '莉子：\n第二類跟第三類動詞，也是直接把字尾的「る」去掉，加上「た」。\n例如：食べる(たべる) 變成 食べた(たべた)。\n来る(くる) 變成 来た(きた)！'),
        (1, '赤真：\n跟「て形」一樣的話那就簡單多了！\n妳已經教會了我所有的動詞變化，我現在是一名非常出色的言靈使了！'),
        (2, '莉子：\n這都多虧了你的努力，赤真。我們一定能一起活著終結這場戰爭... \n(但為什麼...我心裡的這股不安感越來越強烈了...)')
    ],
    #stage 28
    [
        ...
        (2, '莉子：\n飲む(のむ) 變成 飲める(のめる)！\n買う(かう) 變成 買える(かえる)！'),
        (2, '莉子：\n第二類動詞，把字尾的「る」去掉，加上「られる」。\n例如：食べる(たべる) 變成 食べられる(たべられる)！'),
        (2, '莉子：\n第三類不規則動詞：\n来る(くる) 變成 来られる(こられる)！\nする 變成 できる！'),
        (1, '赤真：\n「う段」變成「え段」加「る」...我懂了！\n但就算加上可能形，這傢伙的魔力也太犯規了吧？！'),
        (2, '莉子：\n赤真！這頭魔龍的力量太過龐大，一般魔法是打不贏的！\n在生死存亡之際，你必須作出抉擇！'),
        (2, '莉子：\n殺了我！讓我化身為『混血靈心』！\n這是我身為精靈武器的宿命，這樣你的攻擊力就會翻倍！'),
        (1, '赤真：\n我說過，我絕對不會犧牲妳！！我寧願戰死也...'),
        (2, '莉子：\n不這樣做，我們都會死在這裡！求求你，動手吧！'),
        (3, '系統：【命運的分歧點】\n接下來的選擇將決定莉子的生死，\n並導向完全不同的章節與結局。')
    ],
     #stage 29
    [
    ...
    if game_state == "playing":
        ...
        if battle_detail[stage]["question_type"] == "MC":
            ...
            # The Puzzle Logic
                ...
                try: 
                    prompt_font = pygame.font.Font('media/LXGWMarkerGothic-Regular.ttf', transform_scale([40])[0])
                except Exception: 
                    prompt_font = pygame.font.Font(pygame.font.get_default_font(), transform_scale([40])[0])

                prompt_text = current_q["meaning"]
                text_width = prompt_font.size(prompt_text)[0]
                
                # Default width of 1040, but expands if text is longer (plus 60px padding)
                box_w = max(transform_scale([1040])[0], text_width + transform_scale([60])[0])
                box_x = (WIDTH - box_w) / 2
                box_y, box_h = transform_scale([200, 80])

                pygame.draw.rect(screen, pygame.Color("#f0f0f0"), (box_x, box_y, box_w, box_h), border_radius=10)
                text(screen, prompt_text, (0,0,0), 40, transform_scale([720, 240]), "center")
